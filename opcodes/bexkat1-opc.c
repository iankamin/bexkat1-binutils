...
const bexkat1_opc_info_t bexkat1_opc_info[] =
  {
    ...
    { BEXKAT1_MOV, 0, 0, 2, "mov.l" },
    { BEXKAT1_MOV, 1, 0, 2, "mov" },
    { BEXKAT1_MOV, 2, 0, 2, "mov.b" },
    { BEXKAT1_MOV, 5, 0, 2, "ext" },
    { BEXKAT1_MOV, 6, 0, 2, "ext.b" },
    { BEXKAT1_MOV, 8, 0, 2, "com" },
    { BEXKAT1_MOV, 9, 0, 2, "neg" },
    { BEXKAT1_FP, 0, 0, 2, "neg.s" },
    { BEXKAT1_FP, 1, 0, 2, "cvtis" },
    { BEXKAT1_FP, 2, 0, 2, "cvtsi" },
    { BEXKAT1_FP, 3, 0, 2, "sqrt.s" },
