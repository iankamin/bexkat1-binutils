...
const bexkat1_opc_info_t bexkat1_opc_info[] =
  {
    ...
    { 0x10, 1, BEXKAT1_DIR,    "andsp" },
    { 0x11, 1, BEXKAT1_DIR,    "orsp"  },
    { 0x12, 1, BEXKAT1_DIR,    "addsp" },
    { 0x13, 1, BEXKAT1_DIR,    "subsp" },
    { 0x14, 1, BEXKAT1_DIR,    "lslsp" },
    { 0x15, 1, BEXKAT1_DIR,    "asrsp" },
    { 0x16, 1, BEXKAT1_DIR,    "lsrsp" },
    { 0x17, 1, BEXKAT1_DIR,    "xorsp" },
